...
export default function ApplyBlock(props: ApplyBlockProps) {
    return (
        <div className={`flex flex-col items-center px-10 ${props.className}`}>
            <Image src={founder} width={281} height={281} alt="founder" className="md:self-start" /> 
            <div className='flex flex-col bg-dark-purple p-8 w-[343px] md:w-[514px] -mt-14 md:-mt-32 md:self-end'>
